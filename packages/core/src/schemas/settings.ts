  ...
  banners: z
    ...
    .default([
      ...
      },
      {
        ...
        subtitle: 'Adorable, affordable return gifts for every party.',
        ctaLabel: 'Shop return gifts',
        ctaHref: '/c/kids-return-gifts',
        theme: 'sky',
      },
      {
        id: 'general',
        title: 'Gifts for every occasion',
        subtitle: 'Hampers, decor and personalised keepsakes for the people you love.',
        ctaLabel: 'Shop general gifts',
        ctaHref: '/c/general-gifts',
        theme: 'violet',
      },
    ]),
